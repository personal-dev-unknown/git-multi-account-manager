...
#[allow(dead_code)]
#[derive(Debug)]
pub struct CloudStorageAuthProvider {
    creds: Arc<CredentialService>,
}

impl CloudStorageAuthProvider {
...
#[async_trait]
impl AuthProvider for CloudStorageAuthProvider {
    ...
    async fn refresh_token(
        ...
        Err(GitManagerError::Other(
            "Cloud storage credentials (access keys) cannot be refreshed programmatically.".to_string()
        ))
    }
}
